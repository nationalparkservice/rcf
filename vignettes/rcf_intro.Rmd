...
This vignette will walk through how to use the rcf package. Using the functions in this package will enable users to be make the choice to automatically select Global Climate Models (GCMs) that are most representative of 4 climate futures (CFs) - Warm Wet, Warm Dry (or Damp), Hot Wet, and Hot Dry (or Damp)*.
