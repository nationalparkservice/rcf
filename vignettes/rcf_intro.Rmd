...
For most users of this package, there will only be one more function to run before moving on to graphing. Advanced users can continue to follow along with this vignette or choose to move onto the [PCA intro](https://github.com/nationalparkservice/rcf/blob/main/vignettes/RCF%20instructions%20-%20pca.pdf) vignette.
...
For users that want to try a more advanced approach to finding climate futures, the [Introduction to using PCA for model selection](https://github.com/nationalparkservice/rcf/blob/main/vignettes/RCF%20instructions%20-%20pca.pdf) tutorial will walk you through the process.
