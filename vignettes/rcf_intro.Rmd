...
For most users of this package, there will only be one more function to run before moving on to graphing. Advanced users can continue to follow along with this vignette or choose to move onto the PCA intro(INSERT LINK) vingette.
