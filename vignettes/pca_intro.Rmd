...
To see how to do this, you can follow along with [An Introduction to the Reproducible Climate Futures package](https://github.com/nationalparkservice/rcf/blob/main/vignettes/RCF%20instructions%20-%20simple.pdf).
...
Let's look at the same graphs we looked at in [An Introduction to the Reproducible Climate Futures package](https://github.com/nationalparkservice/rcf/blob/main/vignettes/RCF%20instructions%20-%20simple.pdf)
